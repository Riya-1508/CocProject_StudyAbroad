...
export default function College() {
    ...
    const Universities = getGMapping(CNames,Courses)
    ...
    return (
        <div>
            ...
            <section className="flex flex-row justify-around">
                <div className=" flex flex-row h-screen space-x-44">
                    <div className="w-[600px] h-[600px] m-auto  text-center">
                        <h2 className="m-8 font-bold text-6xl">{Universities.Names}</h2>
                        <p className="m-auto font-medium text-xl  ">{Universities.Details}</p>
                    </div>
                    <div className="flex flex-row ">
                        <img className="w-[550px] h-[450px] m-auto rounded-xl" src={Universities.img} alt="office content 1"></img>
                    </div>
                </div>
            </section>
            <div className='flex flex-col justify-center items-center bg-gray-300 space-y-10 p-5'>
                ...
                {Universities && Universities.College.map((list,index) => {
                    return (
