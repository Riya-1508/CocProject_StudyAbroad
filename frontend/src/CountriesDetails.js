        ...
        },
        {
            ...
            Courses2:
                [
                    {
                        SNo: 1,
                        College: "UUniversity of Cambridge"
                    },
                    {
                        SNo: 2,
                        College: "University of Oxford"
                    ...
                    {
                        SNo: 8,
                        College: "King's College Londone"
                    }
                ],
            Courses3:
                [
        ...
        },
        {
                    ...
                    College: [
                        {
                            ...
                            Names: "The University of Adelaide",
                    ...
                    College: [
                        {
                            ...
                            exams: "To be eligible for UWA's undergraduate degrees based on previous or current Australian Year 12 studies, applicants must have completed the relevant state Certificate of Education and achieved an Australian Tertiary Aggregate Rank (ATAR) of 80 or above, or an Overall Position (OP) of 10 or below.Indian students eligibility:Applicants must get a minimum of 60% marks from Indian School Certificate (CISCE)Applicants must get grade 12 from the All India Senior School Certificate (CBSE). Overall grades in best 4 subjectsApplicants must have qualified for any one of the language tests IELTS/TOEFL  to prove English language proficiency.",
                            __v: 0,
            ...
            Courses2:
                [
                    ...
                    {
                        SNo: 8,
                        College: "winburne University of Technology"
                    }
                ],
            Courses3:
                [
...
export function getCountries(id) {
    return GCountries.find((GCountries) => GCountries.id === id);
}
