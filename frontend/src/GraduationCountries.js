...
import { getCountries } from "./CountriesDetails";
...
function GraduationCountry() {
  ...
  const Countries = getCountries(parseInt(params.id, 10))
  return (
    <div className="" >
      <Navigation />
...
const ButtonCourse = () => {
  const params = useParams();
  const ListofCollege = getListofCollege(parseInt(params.id, 10))
    ...
    <>
      <div className="h-full" >
        <div className="flex justify-evenly mt-8">
          <button className="inline-block p-4 bg-red-600 text-white font-serif text-lg leading-tight rounded-full shadow-md hover:bg-red-700 hover:scale-125 hover:duration-500 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out" onClick={Slist}>{ListofCollege.Courses[0]}</button>
          <button className="inline-block p-4 bg-red-600 text-white font-serif text-lg leading-tight rounded-full shadow-md hover:bg-red-700 hover:scale-125 hover:duration-500 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-outp-4" onClick={Slist2}>{ListofCollege.Courses[1]}</button>
          <button className="inline-block p-4 bg-red-600 text-white font-serif text-lg leading-tight rounded-full shadow-md hover:bg-red-700 hover:scale-125 hover:duration-500 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out" onClick={Slist3}>{ListofCollege.Courses[2]}</button>
  ...
  return (
    <>
        <div className="w-[1000px] h-auto bg-gray-300 rounded-lg mb-16">
            ...
            {ListofCollege.Courses1.map((list) => {
                return (
                    <>
  ...
  return (
    <>
        <div className="w-[1000px] h-auto bg-gray-300 rounded-lg mb-16">
            ...
            {ListofCollege.Courses2.map((list) => {
                return (
                    <>
                        <div className="flex justify-center items-center m-2">
                            <h1 className="text-center p-2 border-2 border-gray-300 w-96 h-10 font-bold text-sm ">{list.SNo}</h1>
  ...
  return (
    <>
        <div className="w-[1000px] h-auto bg-gray-300 rounded-lg mb-16">
            ...
            {ListofCollege.Courses3.map((list) => {
                return (
                    <>
                        <div className="flex justify-center items-center m-2">
                            <h1 className="text-center p-2 border-2 border-gray-300 w-96 h-10 font-bold text-sm ">{list.SNo}</h1>
