      ...
      <section className="flex flex-row justify-around">
        <div className=" flex flex-row h-screen space-x-44">
          <div className="w-[600px] h-[400px] mt-auto mb-auto text-center">
            ...
            <p className="m-4 text-red-600 font-medium text-xl leading-9">{Countries.CDetails}</p>
          </div>
    ...
    <>
      <div className="h-full" >
        <div className="flex justify-evenly mt-8">
          <Link to={`/PGCountryNames/${Countries.CNames}/${Countries.Courses[0]}`} className="inline-block p-4 bg-red-600 text-white font-serif text-lg leading-tight rounded-full shadow-md hover:bg-red-700 hover:scale-125 hover:duration-500 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out" onClick={Slist}>{Countries.Courses[0]}</Link>
          <Link to={`/PGCountryNames/${Countries.CNames}/${Countries.Courses[1]}`} className="inline-block p-4 bg-red-600 text-white font-serif text-lg leading-tight rounded-full shadow-md hover:bg-red-700 hover:scale-125 hover:duration-500 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-outp-4" onClick={Slist2}>{Countries.Courses[1]}</Link>
          {Countries.Courses[2] ? <Link to={`/PGCountryNames/${Countries.CNames}/${Countries.Courses[2]}`} className="inline-block p-4 bg-red-600 text-white font-serif text-lg leading-tight rounded-full shadow-md hover:bg-red-700 hover:scale-125 hover:duration-500 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out" onClick={Slist3}>{Countries.Courses[2] }</Link> : "" }
