    ...
    const submitHandler = async (e) => {
        ...
        if(password !== confirmpassword){ 
            ...
            catch(error)
            {
                ...
                console.log(error);
                diffToast("Email ID/Mobile Number already exists", "error");
            }
        }
        ...
        return (
          <div className="bg-gradient-to-r from-indigo-100 via-pink-300 to-purple-900 h-screen">
            <div className="flex space-x-48 md:flex-shrink-0">
              <div className="mt-20">
                <p className="ml-[330px] text-4xl capitalize font-bold font-mono">
                  Create
                </p>
                <span className="ml-80 text-4xl capitalize font-bold font-mono">
                  Account
                </span>
                <img
                  className="w-[700px] h-[500px] ml-36"
                  src={Photo_Sign}
                  alt=""
                />
              </div>
              ...
              <div className="flex justify-end py-1 pr-40">
                <div className="bg-purple-pink w-96 h-[700px] rounded-3xl flex flex-col justify-center items-center">
                  <h1 className="mb-1 text-2xl text-white font-serif">
                    Sign Up
                  </h1>
                  {message && (
                  ...
                  <a
                    href="/"
                    className="text-white text-md mt-4 hover:underline"
                  >
